...
export default function Bidder() {
    ...
    useEffect(() => {
        axios.get('https://sgqfr6s6f8.execute-api.ap-south-1.amazonaws.com/production/api/tenders/society', config)
            .then(response => {
    ...
    useEffect(() => {
        if (selectedTender) {
            ...
            axios.post('https://sgqfr6s6f8.execute-api.ap-south-1.amazonaws.com/production/api/society-tenders', body, config)
                .then(response => {
